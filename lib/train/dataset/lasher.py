...
class LasHeR(BaseVideoDataset):
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        return os.path.join(seq_path,'visible',rgb_frame_path[frame_id]),os.path.join(seq_path,'infrared',ir_frame_path[frame_id]) # jpg jpg
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        object_class_name = clean_sequence_name(seq_name)
        ...
        object_meta = OrderedDict({'object_class_name': object_class_name,
