...
"""
Add default config for LTUTrack.
"""
cfg = edict()
...
# Optional sequence-name/text feature conditioning for expert routers.
cfg.MODEL.TEXT = edict()
cfg.MODEL.TEXT.ENABLE = False
cfg.MODEL.TEXT.FEATURE_PATH = ""
cfg.MODEL.TEXT.FEATURE_DIM = 512
cfg.MODEL.TEXT.DROPOUT = 0.0
...
cfg.TRAIN.SAVE_EPOCH_INTERVAL = 5 # 1 means save model each epoch
