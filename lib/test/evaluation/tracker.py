...
import lib.test.parameter.cpetrack as params
...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: int = None, display_name: str = None,
        ...
        if self.run_id is None:
            ...
            self.results_dir = '{}/{}/{}_{:02d}'.format(env.results_path, self.name, self.parameter_name, self.run_id)
        if result_only:
    ...
    def create_tracker(self, params,conf_thr=None,update_intervals=None):
        # print(conf_thr)
        if conf_thr !=None:
            params.cfg.TEST.UPDATE_THRESHOLD = conf_thr
        if update_intervals !=None:
            params.cfg.TEST.UPDATE_INTERVALS  = update_intervals
    ...
    def run_sequence(self, seq, debug=None):
        ...
        init_info['sequence_name'] = seq.name
        init_info['object_class_name'] = seq.target_class()
