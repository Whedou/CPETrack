...
from lib.models.cpetrack.utils import combine_tokens, recover_tokens
...
class BaseBackbone(nn.Module):
    ...
    def forward_features(self, z, x, *args, **kwargs):
    ...
    def forward(self, z, x,track_query_before,keep_rate, **kwargs):
        """
        ...
        Returns:
            ...
            attn : None
        """
        x, aux_dict ,len_zx = self.forward_features(z, x,track_query_before,keep_rate, **kwargs)

        return x, aux_dict ,len_zx
